...
class Course:
    ...
    def remove_student(self, student):
        ...
        """
        for stu in self.enroll_student:
            if self.student == student:
                enroll_student.remove(student)
            else:
                break
        
        for stu in self.waitlisted_students:
            if self.student == student:
                waitlisted_students.remove(student)
            else:
                break
        pass
